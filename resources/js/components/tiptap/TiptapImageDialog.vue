        ...
        <div class="modal-dialog modal-dialog-centered">
            <form class="modal-content" @submit.prevent="save">
                <div class="modal-header">
                    <h1 class="modal-title fs-6" :id="props.id + '-label'">{{ t('Image') }}</h1>
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-2">
                        <button type="button" class="btn btn-sm btn-light" @click="browseServer">{{ t('Browse server') }}</button>
                    </div>
                    <div class="mb-2">
...
function browseServer() {
    emitter.emit('openFilePicker', { selectSingleFile: true, emitOnClose: 'openImageDialog' + props.id, type: 'image' });
    show.value = false;
}
