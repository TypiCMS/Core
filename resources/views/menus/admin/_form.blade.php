...
<div class="content">
    ...
    @if ($model->id)
        <item-list-tree url-base="/api/menus/{{ $model->id }}/menulinks" fields="id,menu_id,page_id,position,parent_id,status,title,url" table="menulinks" title="Menulinks" v-if="$can('read menulinks')" :sub-list="true">
