        ...
        <div class="site-container">
            ...
            <header class="header" id="header">
                <div class="header-container">
                    ...
                    @show
                    <a
                        class="d-flex d-lg-none btn-offcanvas"
                        href="#navigation"
                        data-toggle="offcanvas"
                        title="@lang('Open navigation')"
                        aria-label="@lang('Open navigation')"
                        role="button"
                    ...
                    <div class="header-offcanvas" id="navigation">
                        <button
                            class="d-flex d-lg-none btn-offcanvas btn-offcanvas-close"
                            type="button"
                            data-toggle="offcanvas"
                            title="@lang('Close navigation')"
                            aria-label="@lang('Close navigation')"
                            aria-controls="navigation"
                            aria-expanded="false"
                        >
                            <svg width="2.5em" height="2.5em" viewBox="0 0 16 16" fill="currentColor" aria-hidden="true" xmlns="http://www.w3.org/2000/svg">
