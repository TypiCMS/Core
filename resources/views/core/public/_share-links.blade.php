<div class="share-links">
    <ul class="share-links-list">
        ...
        <li class="share-links-item">
            <a
                class="share-links-link share-links-twitter"
                href="https://twitter.com/intent/tweet?text={{ rawurlencode($model->title) }}&url={{ url()->current() }}"
                target="_blank"
                rel="noopener noreferrer"
            >
        ...
        <li class="share-links-item">
            <a
                class="share-links-link share-links-mail"
                href="mailto:?subject={{ rawurlencode($model->title) }}&body={{ url()->current() }}"
                target="_blank"
                rel="noopener noreferrer"
            >
