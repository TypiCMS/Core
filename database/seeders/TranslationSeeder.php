...
class TranslationSeeder extends Seeder
{
    public function run(): void
    {
        $translations = [
            ...
            ['id' => 8, 'translation' => '{"fr":"Merci","en":"Thank you","nl":"Dank u"}', 'key' => 'event registration message', 'created_at' => Carbon::now(), 'updated_at' => Carbon::now()],
            ...
            ['id' => 22, 'translation' => '{"fr":"Veuillez s’il vous plaît corriger les erreurs ci-dessous.","en":"Please correct the errors below.","nl":"Gelieve de onderstaande fouten te corrigeren."}', 'key' => 'message on form error', 'created_at' => Carbon::now(), 'updated_at' => Carbon::now()],
        ];
