...
class MenuSeeder extends Seeder
{
    public function run()
    {
        ...
        $menulinks = [
            ...
            ['id' => 8, 'menu_id' => 4, 'page_id' => 3, 'parent_id' => null, 'image_id' => null, 'position' => 0, 'target' => null, 'class' => null, 'status' => '{"en": 1, "fr": 1, "nl": 1}', 'description' => '{"en": null, "fr": null, "nl": null}', 'title' => '{"en": "Terms and conditions", "fr": "Conditions générales", "nl": "Algemene Voorwaarden"}', 'url' => '{"en": null, "fr": null, "nl": null}', 'created_at' => Carbon::now(), 'updated_at' => Carbon::now()],
            ['id' => 9, 'menu_id' => 4, 'page_id' => 4, 'parent_id' => null, 'image_id' => null, 'position' => 0, 'target' => null, 'class' => null, 'status' => '{"en": 1, "fr": 1, "nl": 1}', 'description' => '{"en": null, "fr": null, "nl": null}', 'title' => '{"en": "Privacy policy", "fr": "Charte vie privée", "nl": "Privacyverklaring"}', 'url' => '{"en": null, "fr": null, "nl": null}', 'created_at' => Carbon::now(), 'updated_at' => Carbon::now()],
            ['id' => 10, 'menu_id' => 4, 'page_id' => 5, 'parent_id' => null, 'image_id' => null, 'position' => 0, 'target' => null, 'class' => null, 'status' => '{"en": 1, "fr": 1, "nl": 1}', 'description' => '{"en": null, "fr": null, "nl": null}', 'title' => '{"en": "Cookie policy", "fr": "Politique des cookies", "nl": "Cookieverklaring"}', 'url' => '{"en": null, "fr": null, "nl": null}', 'created_at' => Carbon::now(), 'updated_at' => Carbon::now()],
        ];
