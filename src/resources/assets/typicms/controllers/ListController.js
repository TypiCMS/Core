...
(function(angular) {
    ...
    angular.module('typicms').controller('ListController', [
        '$http',
        '$scope',
        '$location',
        '$api',
        '$cookies',
        function($http, $scope, $location, $api, $cookies) {
            ...
            $scope.update = function(model, column) {
                ...
                $api.update({ id: model.id }, data).$promise.then(null, function(reason) {
                    alertify.error('Error ' + reason.status + ' ' + reason.statusText);
                });
            };
            ...
            $scope.treeOptions = {
                ...
                dropped: function(event) {
                    ...
                    $http
                        .post('/admin/' + modulePath + '/sort', data)
