        ...
        <header class="site-header" id="site-header">
            <div class="site-header-container">
                ...
                <div class="site-header-offcanvas" id="navigation">
                    <button class="d-flex d-lg-none btn-offcanvas btn-offcanvas-close" data-toggle="offcanvas" title="@lang('Close navigation')" aria-label="@lang('Close navigation')" aria-controls="navigation" aria-expanded="false">
                        <svg width="2.5rem" height="2.5rem" viewBox="0 0 16 16" fill="currentColor" aria-hidden="true" xmlns="http://www.w3.org/2000/svg">
