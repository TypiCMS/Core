    ...
    public function boot(): void
    {
        ...
        */
        $this->publishes([
            ...
            __DIR__.'/../../database/migrations/create_dashboard_table.php.stub' => getMigrationFileName('create_dashboard_table'),
            __DIR__.'/../../database/migrations/create_menus_table.php.stub' => getMigrationFileName('create_menus_table'),
            __DIR__.'/../../database/migrations/create_sitemap_table.php.stub' => getMigrationFileName('create_sitemap_table'),
