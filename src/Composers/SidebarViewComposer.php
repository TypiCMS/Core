    ...
    public function compose(View $view): void
    {
        if (Gate::allows('see dashboard')) {
            $view->offsetGet('sidebar')->group('dashboard', function (SidebarGroup $group): void {
                ...
                $group->hideHeading();
                $group->addItem(
                    __(config('typicms.modules.dashboard.sidebar.label', 'Dashboard')),
        ...
        if (Gate::allows('read pages')) {
            $view->offsetGet('sidebar')->group(
                __(config('typicms.modules.pages.sidebar.group', 'Content')),
                function (SidebarGroup $group): void {
                    $group->id = 'content';
                    $group->weight = 30;
                    $group->addItem(
                        __(config('typicms.modules.pages.sidebar.label', 'Pages')),
                        function (SidebarItem $item): void {
                            $item->id = 'pages';
        ...
        if (Gate::allows('read menus')) {
            $view->offsetGet('sidebar')->group(
                __(config('typicms.modules.menus.sidebar.group', 'Content')),
                function (SidebarGroup $group): void {
                    $group->id = 'content';
                    $group->weight = 30;
                    $group->addItem(
                        __(config('typicms.modules.menus.sidebar.label', 'Menus')),
                        function (SidebarItem $item): void {
                            $item->id = 'menus';
        ...
        if (Gate::allows('read blocks')) {
            $view->offsetGet('sidebar')->group(
                __(config('typicms.modules.blocks.sidebar.group', 'Content')),
                function (SidebarGroup $group): void {
                    $group->id = 'content';
                    $group->weight = 30;
                    $group->addItem(
                        __(config('typicms.modules.blocks.sidebar.label', 'Content blocks')),
                        function (SidebarItem $item): void {
                            $item->id = 'blocks';
        ...
        if (Gate::allows('read tags')) {
            $view->offsetGet('sidebar')->group(
                __(config('typicms.modules.tags.sidebar.group', 'Content')),
                function (SidebarGroup $group): void {
                    $group->id = 'content';
                    $group->weight = 30;
                    $group->addItem(
                        __(config('typicms.modules.tags.sidebar.label', 'Tags')),
                        function (SidebarItem $item): void {
                            $item->id = 'tags';
        ...
        if (Gate::allows('read taxonomies')) {
            $view->offsetGet('sidebar')->group(
                __(config('typicms.modules.taxonomies.sidebar.group', 'Content')),
                function (SidebarGroup $group): void {
                    $group->id = 'content';
                    $group->weight = 30;
                    $group->addItem(
                        __(config('typicms.modules.taxonomies.sidebar.label', 'Taxonomies')),
                        function (SidebarItem $item): void {
                            $item->id = 'taxonomies';
        ...
        if (Gate::allows('read translations')) {
            $view->offsetGet('sidebar')->group(
                __(config('typicms.modules.translations.sidebar.group', 'Content')),
                function (SidebarGroup $group): void {
                    $group->id = 'content';
                    $group->weight = 30;
                    $group->addItem(
                        __(config('typicms.modules.translations.sidebar.label', 'Translations')),
                        function (SidebarItem $item): void {
        ...
        if (Gate::allows('read users')) {
            $view->offsetGet('sidebar')->group(
                __(config('typicms.modules.users.sidebar.group', 'Users and roles')),
                function (SidebarGroup $group): void {
                    $group->id = 'users';
                    $group->weight = 50;
                    $group->addItem(
                        __(config('typicms.modules.users.sidebar.label', 'Users')),
                        function (SidebarItem $item): void {
                            $item->id = 'users';
        ...
        if (Gate::allows('read roles')) {
            $view->offsetGet('sidebar')->group(
                __(config('typicms.modules.roles.sidebar.group', 'Users and roles')),
                function (SidebarGroup $group): void {
                    $group->id = 'users';
                    $group->weight = 50;
                    $group->addItem(
                        __(config('typicms.modules.roles.sidebar.label', 'Roles')),
                        function (SidebarItem $item): void {
                            $item->id = 'roles';
        ...
        if (Gate::allows('read files')) {
            $view->offsetGet('sidebar')->group(
                __(config('typicms.modules.files.sidebar.group', 'Media')),
                function (SidebarGroup $group): void {
                    $group->id = 'media';
                    $group->weight = 40;
                    $group->addItem(
                        __(config('typicms.modules.files.sidebar.label', 'Files')),
                        function (SidebarItem $item): void {
                            $item->id = 'files';
